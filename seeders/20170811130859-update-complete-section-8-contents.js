      ...
      segments: [
        ...
        },
        {
          ...
          options: {
            ...
            value:
              '<ul><li><strong>Study procedures and their timing are summarized in the SoA. Protocol waivers or exemptions are not allowed.</strong></li><li><strong> Immediate safety concerns should be discussed with the sponsor immediately upon occurrence or awareness to determine if the participant should continue or discontinue study intervention.</strong></li><li><strong>Adherence to the study design requirements, including those specified in the SoA, is essential and required for study conduct.</strong></li><li><strong>All screening evaluations must be completed and reviewed to confirm that potential participants meet all eligibility criteria. The investigator will maintain a screening log to record details of all participants screened and to confirm eligibility or record reasons for screening failure, as applicable. </strong></li><li><strong>Procedures conducted as part of the participant’s routine clinical management (eg, blood count) and obtained before signing of the ICF may be utilized for screening or baseline purposes provided the procedures met the protocol-specified criteria and were performed within the time frame defined in the SoA.</strong></li></ul>',
          },
        },
        {
          type: 'Heading',
        ...
        },
        {
          ...
          options: {
            ...
            value:
              '<p>Care will be taken not to introduce bias when detecting AEs and/or SAEs. Open-ended and non leading verbal questioning of the participant is the preferred method to inquire about AE occurrences. </p>',
          },
        },
        {
          type: 'Heading',
        ...
        },
        {
          ...
          options: {
            ...
            value:
              '<p>After the initial AE/SAE report, the investigator is required to proactively follow each participant at subsequent visits/contacts. All SAEs will be followed until resolution, stabilization, the event is otherwise explained, or the participant is lost to follow-up (as defined in Section 7.3). Further information on follow-up procedures is given in Appendix 3.</p>',
          },
        },
        {
          type: 'Heading',
        ...
        },
        {
          ...
          options: {
            ...
            value:
              '<p>Cardiovascular events should be assessed and recorded as an Adverse Event or Serious Adverse Event, following the procedures detailed in Appendix 3.</p><p>Death due to progression of disease is the primary endpoint for this study and should be recorded on the corresponding CRF.</p>',
          },
        },
        {
          type: 'Heading',
        ...
        },
        {
          ...
          options: {
            ...
            value:
              '<p>Not applicable, any disease related events (DREs) should continue to be reported using the standard AE and SAE reporting procedures. </p>',
          },
        },
        {
          type: 'Heading',
